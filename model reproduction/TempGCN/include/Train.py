...
class trainTransE:
    ...
    def __init__(self):
        self.inAdd = "./data/YAGO/"
        self.outAdd = "./data/YAGO/"
        self.preAdd = "./data/YAGO/"
        self.preOrNot = False
    ...
    def train(self):
        read = readData(self.inAdd, self.train2id, self.headRelation2Tail, self.tailRelation2Head, self.nums)
