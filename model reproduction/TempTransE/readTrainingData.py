...
class readData:
    def __init__(self, inAdd, train2id, headRelation2Tail, tailRelation2Head, nums, start, seq_len):
        self.inAdd = inAdd
        ...
        self.readTrain2id(start, seq_len)
    ...
    def readTrain2id(self, start, seq_len):
        ...
        train_TKG, maxtime = load_TKG(self.inAdd, 'train_quadruples.txt')

        #train_TKG, valid_TKG, test_TKG = set_partition(TKG, 0.7, 0.1)
        SKG = get_static_graph(train_TKG, start, seq_len)
