...
if __name__ == '__main__':
    ...
    train_SKG = load_static_graph(Config.data, 'train_quadruples.txt', 2186215, 0)
    test_SKG = load_static_graph(Config.data, 'test_quadruples.txt', 2186215, 0)
    valid_SKG = load_static_graph(Config.data, 'valid_quadruples.txt', 2186215, 0)
